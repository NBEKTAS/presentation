              ...
              <div className="flex flex-col h-full gap-2.5 @sm:gap-3.5 @xl:gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 @sm:gap-3.5 @xl:gap-4 mb-2 @sm:mb-2.5 @xl:mb-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <h2 className="text-lg @sm:text-xl @lg:text-xl @xl:text-2xl @2xl:text-2xl font-black text-slate-900 leading-snug tracking-tight">
                        {item.title}
                      </h2>
                    </div>
                  </div>
                ...
                <div className="flex-1 flex flex-col justify-evenly py-1 gap-2 @xl:gap-2">
                  {item.points.map((pt, pIdx) => (
                    <div
                      key={pIdx}
                      className="flex items-start gap-2.5 @sm:gap-3 text-sm @sm:text-sm @lg:text-[15px] @xl:text-base @2xl:text-base text-slate-700 leading-relaxed"
                    >
