...
export const Slide9Takeaways: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between max-w-[115.625rem] mx-auto p-2 sm:p-4 lg:p-5 xl:p-6 overflow-y-auto">
      {/* Slide Header: Clean, Uncluttered Title & Subtitle */}
              ...
              <div className="flex flex-col h-full gap-2.5 sm:gap-3.5 xl:gap-4">
                ...
                <div className="flex-1 flex flex-col justify-evenly py-1 gap-2 xl:gap-3">
                  {item.points.map((pt, pIdx) => (
                    <div
                      key={pIdx}
                      className="flex items-start gap-2.5 sm:gap-3 text-xs sm:text-sm lg:text-[15px] xl:text-base 2xl:text-[17.5px] text-slate-700 leading-relaxed"
                    >
